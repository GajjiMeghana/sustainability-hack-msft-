            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <p class="card-text text-center">Kurnool,Andhra Pradesh<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:lightgreen;color:black">View Profile </button>
                        </p>
