...
.myfooter ul.social li a:before {
  content: '';
  position: absolute;
  top: 50%;
  left: 50%;
...
.myfooter ul.social li a:hover:before {
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    echo "<a href='subsriptions.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Subscriptions</a>";
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        echo "<a href='subsriptions.php' class='dropdown-item'  style='padding-right:-20px;'>Subscriptions</a>";
    ...
    <div class="container">
        <div class="d-flex justify-content-around bg-MediumSeaGreen mb-3">
    ...
    <div class="container"> <img src="mainpg.JPG" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    ...
                    <p class="h6">Copy All right Reversed.<a class="text-black ml-2" href="https://www.google.com" target="_blank">CropSwap</a></p>
                </div>
                </hr>
            </div>
        </div>
