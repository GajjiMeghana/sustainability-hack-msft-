...
.myfooter ul.social li a i {
  font-size: 30px;
  color: goldenrod;
  transition: all 0.2s ease-in-out;
}

.myfooter ul.social li a:hover i {
  color: white;
}
...
<br>
    ...
    <div class="container" >
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:black;color:mediumseagreen">Edit Profile</button>
    </div>
