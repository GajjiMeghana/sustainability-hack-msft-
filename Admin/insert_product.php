...
<style>
    body {
        background-image: url(../Images/Website/agri.jpg);
    ...
    #protitle td:first-child,
    #procat td:first-child,
    #prostock td:first-child,
    #procalender td:first-child,
    #proimg td:first-child,
    #propriceMax td:first-child,
    #propriceMin td:first-child,
    #prodesc td:first-child,
    #prokey td:first-child,
    #dev td:first-child {
        font-weight: bold;
        padding-right: 20px;
    }
