...
/* Set table elements to display block with 100% width */
.table,
.table tbody,
.table tr,
.table td {
...
/* Add margin-bottom to table rows */
.table tr {
    margin-bottom: 15px;
}

/* Set text-align and padding for table cells */
.table td {
    text-align: right;
    padding-left: 50%;
    position: relative;
...
/* Set display to flex for elements with class 'left' */
.left {
    display: flex;
}

/* Hide elements with class 'moblogo' */
.moblogo {
    display: none;
}

/* Center text and add padding to elements with class 'logins' */
.logins {
    text-align: center;
    margin-right: 35%;
    padding: 15px;
...
/* Set width and margins for search box */
.searchbox {
    width: 95%;
    margin-right: 5%;
    margin-left: 0%;
...
/* Set display, text-align and width for elements with class 'moblists' */
.moblists {
    display: inline-block;
    text-align: center;
    width: 100%;
