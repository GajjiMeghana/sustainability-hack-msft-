...
<body>
     ...
     <body>
          ...
          <div class="card">
               ...
               <div class="card-body">
                    <h5 class="card-title text-center font-weight-bold text-primary">You Can Upload Sms by using Following Syntax</h5>
                    <div class="card-deck">
                         <div class="card">

                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center text-primary">Insert Product</h5>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                              <h5 class="card-title font-weight-bold text-center text-primary">Update Product</h5>
<p class="card-text text-muted">*#*,update,password,product title,product category , product type , product stock ,MRP,Base Price, product keywords , product description ,product delivery</p>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center text-primary">Delete Product</h5>
