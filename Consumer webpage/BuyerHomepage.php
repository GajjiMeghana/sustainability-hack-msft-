...
<body>
	...
	<div class="instaid">
		<div class="text"><a href="#" style="color:black;">@CropSwap</a></div>
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">cropswap@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.CropSwap.com</h5>
	</div>
</body>
