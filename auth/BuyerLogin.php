    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-image: url('logtwo.JPG');
            background-size: 100%;
        }
        .my-form,
.login-form {
    ...
    <main class="my-form">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header border border-dark" style="background-color:MediumSeaGreen">
                            <h4 style="font-style:bold;color:black;text-align:left"> BuyerLogin</h4>
                        </div>
                        <div class="card-body border border-dark">
                            <form name="my-form" action="BuyerLogin.php" method="post">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn " style="background-color:MediumSeaGreen;color:black" name="login" value="Login">
                                        Login
                                    </button>
                                </div>
                                <br>
                                <div class="col-md-6 offset-md-4">
                                    <label id="forgotPassword"><a id='link' href="BuyerForgotPassword.php"><b style="color:green"> Forgot your password ?</b></a></label>
                                    <br>
                                    <label id="account"><a id='link' href="BuyerRegistration.php"><b style="color:green">Create New Account</b></a></label>
                                </div>
                            </form>
                        </div>
                    </div>
