...
/* Apply font family and default padding to forms */
.my-form, .login-form {
    font-family: 'Roboto', sans-serif;
    padding: 1.5rem;
}

/* Remove default margins from form rows */
.my-form .row, .login-form .row {
    margin: 0;
}

/* Style form labels */
.my-form label, .login-form label {
    display: block;
...
/* Style form inputs */
.my-form input, .login-form input {
    width: 100%;
    padding: 0.5rem;
...
/* Style form buttons */
.my-form button, .login-form button {
...
.my-form button:hover, .login-form button:hover {
    background-color: #0069d9;
}

/* Style form error messages */
.my-form .error-message, .login-form .error-message {
    color: #dc3545;
    margin-top: 0.5rem;
}

/* Add some spacing between form sections */
.my-form h2, .login-form h2 {
    margin-top: 1.5rem;
    margin-bottom: 0.5rem;
}
